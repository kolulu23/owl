...
public interface OwlListener extends ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    void enterArr_Sized(OwlParser.Arr_SizedContext ctx);

    /**
     * Exit a parse tree produced by the {@code Arr_Sized}
     * labeled alternative in {@link OwlParser#arr}.
     *
     * @param ctx the parse tree
     */
    void exitArr_Sized(OwlParser.Arr_SizedContext ctx);

    /**
     * Enter a parse tree produced by the {@code Arr_Empty}
     * labeled alternative in {@link OwlParser#arr}.
     *
     * @param ctx the parse tree
     */
    void enterArr_Empty(OwlParser.Arr_EmptyContext ctx);

    /**
     * Exit a parse tree produced by the {@code Arr_Empty}
     * labeled alternative in {@link OwlParser#arr}.
     *
     * @param ctx the parse tree
     */
    void exitArr_Empty(OwlParser.Arr_EmptyContext ctx);
     ...
     * @param ctx the parse tree
     */
    void enterLit_Int(OwlParser.Lit_IntContext ctx);
     ...
     * @param ctx the parse tree
     */
    void exitLit_Int(OwlParser.Lit_IntContext ctx);

    /**
     * Enter a parse tree produced by the {@code Lit_Neg_Int}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void enterLit_Neg_Int(OwlParser.Lit_Neg_IntContext ctx);

    /**
     * Exit a parse tree produced by the {@code Lit_Neg_Int}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void exitLit_Neg_Int(OwlParser.Lit_Neg_IntContext ctx);

    /**
     * Enter a parse tree produced by the {@code Lit_Double}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void enterLit_Double(OwlParser.Lit_DoubleContext ctx);

    /**
     * Exit a parse tree produced by the {@code Lit_Double}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void exitLit_Double(OwlParser.Lit_DoubleContext ctx);

    /**
     * Enter a parse tree produced by the {@code Lit_Neg_Double}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void enterLit_Neg_Double(OwlParser.Lit_Neg_DoubleContext ctx);

    /**
     * Exit a parse tree produced by the {@code Lit_Neg_Double}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void exitLit_Neg_Double(OwlParser.Lit_Neg_DoubleContext ctx);
     ...
     * @param ctx the parse tree
     */
    void enterLit_String(OwlParser.Lit_StringContext ctx);
     ...
     * @param ctx the parse tree
     */
    void exitLit_String(OwlParser.Lit_StringContext ctx);

    /**
     * Enter a parse tree produced by the {@code Lit_Boolean}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void enterLit_Boolean(OwlParser.Lit_BooleanContext ctx);

    /**
     * Exit a parse tree produced by the {@code Lit_Boolean}
     * labeled alternative in {@link OwlParser#literal}.
     *
     * @param ctx the parse tree
     */
    void exitLit_Boolean(OwlParser.Lit_BooleanContext ctx);
